...
class WebotsEnv(Env):
    def __init__(self, driver):
        ...
        # self.state = np.random.uniform(low=0, high=1.0, size=(1,182))
...
model.learn(total_timesteps=7000, callback=save_datas_callback)
# Save the trained model
model.save("mlp_model_phase2_ppo_policy")
